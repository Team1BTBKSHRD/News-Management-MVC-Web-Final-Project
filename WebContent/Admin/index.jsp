						...
						<div class="panel panel-success-alt noborder">
							<div class="panel-heading noborder">
								...
								<div class="media-body">
									...
									<h1 class="mt5" id="das_cou_category">$8,102.32</h1>
								</div>
								<!-- media-body -->
								<hr>
						...
						<div class="panel panel-primary noborder">
							<div class="panel-heading noborder">
								...
								<div class="media-body">
									...
									<h1 class="mt5" id="das_cou_account">138,102</h1>
								</div>
								<!-- media-body -->
								<hr>
								<!-- <div class="clearfix mt20">
						...
						<div class="panel panel-dark noborder">
							<div class="panel-heading noborder">
								...
								<div class="media-body">
									...
									<h1 class="mt5" id="das_cou_article">153,900</h1>
								</div>
								<!-- media-body -->
								<hr>
								<!-- <div class="clearfix mt20">
				...
				<div class="row row-dashboard">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							</div><!-- input-group mb15 -->
							

							<h6
								style="text-transform: uppercase; font-size: 12px; font-weight: bold;">UserType:</h6>
							<span id="summery_show_usertype"></span>
							<h6
								style="text-transform: uppercase; font-size: 12px; font-weight: bold;">Number
								of Artcle Post:</h6>
							<span id="summery_count_of_article"></span> <br />
