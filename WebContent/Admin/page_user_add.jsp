                                  ...
                                  <div class="panel-body">
                                    <div class="row">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="password" id="password" name="password" class="form-control" placeholder="Type your password..." autocomplete="off" required />
                                          <br/>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="password" id="repassword" name="repassword" class="form-control" placeholder="Retype your password..." autocomplete="off" required />
                                        </div>
                                      </div><!-- form-group -->
