...
<body>
	...
	<div class="container content-area">
		...
		<div class="col-md-9 col-sm-9 col-xs-9 clear-padding-left ">
			...
			<div class="category-header col-sm-12 clear-paddings"
				...
				<img
					src="http://architecture-view.com/wp-content/uploads/2010/09/Garden-of-Knowledge-Book-Walls-Structure.jpg"
				...
				<div class="category-title "
					...
					<h4 class="article-name" style="color: #FFE4F4; font-size: 30px;">ពត័មានជាតិក្នុងស្រុក</h4>
				</div>
			</div>
	...
	<script src="js/custom/localnews.js"></script>
	<!-- end custom js -->
	<!-- #####################end javascript#################### -->
</body>
</html>