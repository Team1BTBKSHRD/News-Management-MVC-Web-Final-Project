    ...
    <div class="col-md-9 col-sm-9 col-xs-9 clear-padding-left left-panel">
        ...
        <div class="panel panel-primary" id="localnews-scroll">
            <div class="panel-heading">
                <a href="category?id=B030101"><h3 class="panel-title">ព័ត៌មានជាតិទូទៅ</h3></a>
        ...
        <div class="panel panel-primary" id="technews-scroll">
            <div class="panel-heading">
                <a href="category?id=B010105"><h3 class="panel-title"> បច្ចេកវិទ្យា</h3></a>
        ...
        <div class="panel panel-primary" id="sportnews-scroll">
            <div class="panel-heading">
                <a href="category?id=B020201"><h3 class="panel-title"> កីឡា</h3></a>
        ...
        <div class="panel panel-primary" id="knowledgenews-scroll">
            <div class="panel-heading">
                <a href="category?id=B020501"><h3 class="panel-title">ចំនេះដឺង </h3></a>
                <div class="btn-group">
        ...
        <div class="panel panel-primary" id="socialnews-scroll">
            <div class="panel-heading">
                <a href="category?id=B030102"><h3 class="panel-title"> សង្គម</h3></a>
        ...
        <div class="panel panel-primary" id="economicnews-scroll">
            <div class="panel-heading">
                <a href="category?id=B030401"><h3 class="panel-title"> សេដ្ឋកិច្ច </h3></a>
        ...
        <div class="panel panel-primary" id="entertainmentnews-scroll">
            <div class="panel-heading">
                <a href="category?id=B020302"><h3 class="panel-title">សិល្បៈកម្សាន្ត</h3></a>
        ...
        <div class="panel panel-primary" id="lifeandjobsnews-scroll">
            <div class="panel-heading">
                <a href="#"><h3 class="panel-title">ជីវិត និងការងារ</h3></a>
