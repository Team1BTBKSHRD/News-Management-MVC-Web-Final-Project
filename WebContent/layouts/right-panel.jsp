	...
	<div class="panel panel-primary container-fluid">
		<form role="search">
			<div
				...
				<input class="col-sm-8" type="text" placeholder="ស្វែងរក" id="inputSearch">
				<button type="submit" class="btn btn-primary pull-right col-sm-4" id="btnSearch">ស្វែងរក</button>
			</div>
		</form>
	</div>
	<!-- end search form -->
