      ...
      <!-- article -->
        ...
        <div class="col-sm-9 content-left clear-padding-left clear-margins left-panel">
          <div class="panel panel-primary clear-margins">
            ...
            <div class="news-image" style='background-image: url(${ad.getImg_path()}),  url(img/404.jpg)'></div>
            ...
            <div class="panel-body" style="margin-bottom: 30px;">
                ...
                <div class="row card-header card-news clear-paddings clear-margins">
                  ...
                  <div class="col-sm-12">
                    ...
                    <p class="col-sm-6 article-info pull-left">
                      <strong >ចេញផ្សាយ 
                      <kbd><time>${ad.getNews_date()}</time></kbd>
                      </strong> 
                    </p>
                    <!-- news category -->
                    <p class="col-sm-6 article-info pull-right" style="text-align: right;">
                      <strong>ប្រភេទព័ត៌មាន<kbd>${ad.getNew_source()}</kbd> </strong>
                    </p>
              ...
              <div class="col-sm-12" style='margin-bottom:15px'>
                <hr>
               	<strong>អត្ថបទដោយ៖ </strong><kbd>${ad.getAuthor()}</kbd>
              </div>
            </div>
            <!-- end article body -->
          </div>
