        ...
        <div class="panel panel-primary container-fluid clear-margin-right">
            ...
            <div class=" form-group col-sm-6">
                <div class="btn-group combo-news">
                    <a class="btn btn-default  search-filter" id="showNews">ប្រភពព័ត៌មាន</a>
                ...
                <div class="btn-group combo-news">
                    <a class="btn btn-default search-filter" id="showTime">ពេលវេលា</a>
                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                       aria-expanded="false"><span class="caret"></span></a>
                    <!--news source-->
                ...
                <div class="btn-group combo-news">
                    <a class="btn btn-default search-filter" id="showItem">ចំនួនលទ្ធផល​ ១០</a>
                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                       aria-expanded="false"><span class="caret"></span></a>
                    <!--news source-->
