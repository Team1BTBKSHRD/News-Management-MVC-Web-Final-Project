...
<body>
	...
	<div class="container-fluid content-area">
		...
		<div class="col-sm-4 card content-right clear-paddings pull-right">
			<div class="row card-header">
				<form role="search">
					<input type="text" class="col-sm-7" style="margin-left: 15px"
						placeholder="Search">
			...
			<div class="row card-header">
				<form role="search">
					<input type="text" class="col-sm-7 " style="margin-left: 15px"
						placeholder="Search">
					<button type="submit" class="col-sm-3 btn btn-primary"
						style="margin-left: 15px">Sesarch</button>
				</form>
			</div>
			<hr width="85%">
			<div class="row card-header">
		...
		<div class="content">
			<div class="col-sm-8 content-left clear-padding-left">
								...
								<div
									...
									<div class="col-sm-8 pull-right">
										...
										<p class="clear-margin-bottom">
											...
											កាពីទបន្ទាប់​ពី​ភរិយា​ស្លាប់​ទៅ កាពីទ <strong
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">International news</h3>
					</div>
					<div class="panel-body">
						<div class="card">
							<a href="http://news.sabay.com.kh/article/298488" target="_new">
