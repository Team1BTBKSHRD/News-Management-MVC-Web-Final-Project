            ...
            <div class="headerwrapper" style="background-color: #5CB85C;">
                <div class="header-left">
                    <a href="index.jsp" class="logo">
                        <img class="img-responsive" style="width: 69px;height: 24px;" src="img/logo.png"  alt="" /> 
                    </a>
                       ...
                       <!--  <form class="form form-search" action="http://themepixels.com/demo/webpage/chain/search-results.html">
                        ...
                        <div class="btn-group btn-group-option">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                              <li><a href="page_user_profile.jsp" id="hdn_myprofile"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
